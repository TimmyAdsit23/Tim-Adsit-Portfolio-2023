...
public class SequenceAlignmentDriver {
    ...
    public static void main(String args[])
    {
        ...
        System.out.println("test1.getAlignment().compareTo(\"mean- n-ame\"): " + test.getAlignment().compareTo("mean- n-ame"));
        System.out.println("should be: mean- n-ame");
        System.out.println(test.getAlignment());
        ...
        System.out.println("test2.getAlignment().compareTo(\"a-cross accross\"): " + test2.getAlignment().compareTo("a-cross accross"));
        System.out.println("should be: a-cross accross");
        System.out.println(test2.getAlignment());
        ...
        System.out.println("test3.getAlignment().compareTo(\"four fo-r\"): " + test3.getAlignment().compareTo("four fo-r"));
        System.out.println("should be: four fo-r");
        System.out.println(test3.getAlignment());
        ...
        System.out.println("test4.getAlignment().compareTo(\"runnnning ru--nning\"): " + test4.getAlignment().compareTo("runnnning ru--nning"));
        System.out.println("should be: runnnning ru--nning");
        System.out.println(test4.getAlignment());
        ...
        System.out.println("test5.getAlignment().compareTo(\"progra--mming programmmming\"): " + test5.getAlignment().compareTo("progra--mming programmmming"));
        System.out.println("should be: progra--mming programmmming");
        System.out.println(test5.getAlignment());
