...
// ===========================
// StringMuncher: testcase17.c
// ===========================
// Tests behavior of expandDigestiveTract() with various invalid inputs.
...
int main(void)
{
	...
	assert(expandDigestiveTract(munchy, -1) == NULL);
	assert(expandDigestiveTract(munchy, 12) == NULL);
	assert(expandDigestiveTract(munchy, 15) == NULL);
	assert(expandDigestiveTract(NULL, 20) == NULL);
